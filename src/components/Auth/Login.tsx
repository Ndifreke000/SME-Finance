        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <DollarSign className="text-blue-600 mr-2" size={32} />
              <h1 className="text-2xl font-bold text-gray-900">NairaBooks</h1>
            </div>
            <p className="text-gray-600">Nigerian SME Financial Management</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg overflow-hidden">
            ...
            <div className="space-y-2 text-sm overflow-x-auto">
              <div>
                ...
                <p className="text-gray-600 break-all">Email: admin@nairabooks.ng</p>
                <p className="text-gray-600">Password: admin123</p>
              </div>
              <div>
                <p className="text-gray-700"><strong>User:</strong></p>
                <p className="text-gray-600 break-all">Email: user@nairabooks.ng</p>
